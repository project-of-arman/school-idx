...
import { BookOpen, Target, Users, History, Award, Building, BadgeCheck } from "lucide-react";
...
const features = [
    {
        icon: History,
        title: "আমাদের ইতিহাস",
        description: "শিক্ষা অঙ্গন প্রতিষ্ঠিত হয়েছিল ১৯৯০ সালে। প্রতিষ্ঠার পর থেকে আমরা জ্ঞানের আলো ছড়িয়ে যাচ্ছি এবং হাজারো শিক্ষার্থীর भविष्य গড়ে তুলেছি। আমাদের রয়েছে দীর্ঘদিনের গৌরবময় ইতিহাস।"
    },
    {
        icon: Target,
        ...
        <div className="container mx-auto px-4 space-y-24">
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
                ...
                <div className="w-full md:w-7/12">
                    <h2 className="text-3xl font-bold text-primary mb-4 font-headline">শিক্ষা অঙ্গন: একটি আদর্শ বিদ্যাপীঠ</h2>
                    <p className="text-muted-foreground mb-6 text-base leading-relaxed">
                    শিক্ষা অঙ্গন একটি ঐতিহ্যবাহী এবং স্বনামধন্য শিক্ষা প্রতিষ্ঠান। আমরা শিক্ষার্থীদের মধ্যে জ্ঞান, সৃজনশীলতা এবং নৈতিক মূল্যবোধের বিকাশ ঘটাতে প্রতিশ্রুতিবদ্ধ। আমাদের লক্ষ্য হলো প্রতিটি শিক্ষার্থীকে একজন দায়িত্বশীল নাগরিক হিসেবে গড়ে তোলা। একটি অভিজ্ঞ শিক্ষক মণ্ডলী, আধুনিক শ্রেণীকক্ষ এবং সমৃদ্ধ লাইব্রেরি নিয়ে আমাদের পথচলা। আমরা বিশ্বাস করি, সঠিক পরিচর্যা এবং অনুকূল পরিবেশ পেলে প্রতিটি শিক্ষার্থীই তার সুপ্ত প্রতিভা বিকশিত করতে পারে।
                    </p>
                </div>
            </div>
            ...
            <Card className="shadow-lg">
                <CardHeader>
                    <div className="flex items-center gap-4">
                        ...
                        <CardTitle className="text-2xl text-primary font-headline">পাঠদান ও স্বীকৃতি</CardTitle>
                    </div>
                </CardHeader>
                <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
                   <p>শিক্ষা অঙ্গন একটি সরকার-অনুমোদিত শিক্ষা প্রতিষ্ঠান এবং এটি ঢাকা শিক্ষা বোর্ডের অধিভুক্ত। আমরা জাতীয় শিক্ষাক্রম ও পাঠ্যপুস্তক বোর্ড (এনসিটিবি) কর্তৃক নির্ধারিত পাঠ্যসূচি অনুসরণ করি। আমাদের শিক্ষাদান পদ্ধতি আধুনিক ও বিজ্ঞানসম্মত, যা শিক্ষার্থীদের সৃজনশীলতা এবং সমালোচনামূলক চিন্তাভাবনার বিকাশে সহায়তা করে।</p>
