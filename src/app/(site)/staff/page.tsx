    ...
    <div className="bg-white">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {teachers.map((person) => (
            <Link href={`/teachers/${person.id}`} key={person.id} className="block h-full">
                <Card className="overflow-hidden group shadow-md hover:shadow-xl transition-all duration-300 text-center h-full flex flex-col">
