...
/*
SQL for creating the certificate_applications table:
...
export async function saveCertificateApplication(formData: FormData) {
  try {
    if (!pool) {
    ...
    console.error("Failed to save certificate application:", error);
